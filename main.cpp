...
void jogador2(char pecastab[9][9], bool &fim_de_jogo){
       ...
       if(nova_colunaint == 1||3||5||7 && nova_linha == 2||4||6||8){
             if(pecastab[nova_linha][nova_colunaint]==' '){
                if((nova_colunaint == colunaint-1 || nova_colunaint == coluna+1) && nova_linha == linha-1){
                    posicao_correta = true;
                }
                else {
         ...
         if(nova_colunaint == 2||4||6||8 && nova_linha == 1||3||5||7){
             if(pecastab[nova_linha][nova_colunaint]==' '){
                if((nova_colunaint == colunaint+1 && nova_linha == linha-1)|| (nova_colunaint == colunaint-1 && nova_linha == linha-1)) {
                    posicao_correta = true;
                }
                else {
                    posicao_correta = false;
...
int main()
{
      ...
      if(menu_choice == 1){
          tabuleiro(pecastab);
          cout << " Jogador 1: peça x" << endl << " Jogador 2: peça o" << endl;
          do{
